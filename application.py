...
def buy():
    ...
    if request.method == "POST":
        ...
        if shares <= 0:
            return apology("Numbers of shares must be positive integer!")
...
def register():
    ...
    if (request.method == "POST"):
        ...
        if not username:
            return apology("Username requried to proceed!")
        elif not password:
            return apology("Password requried to proceed!")
        elif not confirmation:
            return apology("Password confirmation required to proceed!")
